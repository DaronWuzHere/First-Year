...
{  
  ...
  private static void printQuad(QuadPoly quadratic1, QuadPoly quadratic2)
  {
    ...
    {
      System.out.println("The polynomial:     " + quadratic1.toString());
      System.out.println("Is equal to:        " + quadratic2.toString());
    }//If
    else
    {
      ...
      {
        System.out.println("The polynomial:     " + quadratic1.toString());
        System.out.println("Is less than:       " + quadratic2.toString());
      }//If
      else 
      {
        System.out.println("The polynomial:       " + quadratic1.toString());
        System.out.println("Is greater than:      " + quadratic2.toString());
      }//Else
    }//Print Quad          
