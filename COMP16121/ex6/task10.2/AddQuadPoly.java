...
{  
  ...
  {
    System.out.println("Polynomial:      " + quadratic1.coeffic1 + "x^2 +" + quadratic1.coeffic2
                       + "x + " + quadratic1.coeffic3);

    System.out.println("Added to:        " + quadratic2.coeffic1 + "x^2 +" + quadratic2.coeffic2
                       + "x + " + quadratic2.coeffic3);

    System.out.println("Results in:      " + (quadratic1.coeffic1 + quadratic2.coeffic1)
                       + "x^2 +" + (quadratic1.coeffic2 + quadratic2.coeffic2) + "x + " 
                       + (quadratic1.coeffic3 + quadratic2.coeffic3));
  }//Print Quad
}//Add Quad Poly
