...
printAgeHistory	PUSH	{R0-R2,R4-R6,LR}			; callee saves three registers
...
end2		POP	{R0-R2,R4-R6,LR}		; callee saved registers
;		ADD	SP, SP, #12
		MOV	PC, LR
...
; printAgeHistory(pDay, pMonth, 2000);
		...
		PUSH	{R0-R2}
		BL	printAgeHistory
		POP	{R0-R2}			; Deallocate three 32-bit variables {pop r0 - r2}
...
; printAgeHistory(13, 11, 2000);
		...
		PUSH	{R0-R2}
		BL	printAgeHistory
		POP	{R0-R2}			; Deallocate three 32-bit variables
